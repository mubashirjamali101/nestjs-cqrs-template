...
export interface IResetPasswordEmailTemplateData {
  otpCode: string
  firstName: string
  lastName: string
  email: string
...
<html lang="en">
  ...
  <body>
    <div class="container">
      ...
      <p>We received a request to reset your password for your account (${email}). To proceed with the password reset, please use the verification code below:</p>
